...
import com.jle_official.token_service.common.exception.MemberAdapterException;
...
public class PrincipalDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String memberId) {
        ...
        try{
            memberInfo = memberAdapter.getMemberInfo(memberId);
            password = memberAdapter.getMemberCredential(memberId);
            log.debug("member Id: {}", memberInfo.getMemberId());
            log.debug("password: {}", password);
        } catch (Exception e) {
            throw new MemberAdapterException("loadUserByUsername error: "+e.getMessage());
        }
